...
def initialize_args(bit_length, search_depth):
    ...
    args["path_results"] = "results/point/"
    ...
    args["network_type"] = "FC"  # CNN or FC
    create_dir(args)
...
def main():
    ...
    def env_maker():
        env = PointEnv( horizon=args['horizon'], radius=args['radius'], distance_reward=args['distance_reward'])
        return env
