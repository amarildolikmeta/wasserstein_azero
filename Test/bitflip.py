...
def argument_parser():
    ...
    CLI.add_argument(
        "--bit_depth",  # name on the CLI - drop the `--` for positional/required parameters
        type=int,
        default=15,
        help="number of bits")
    CLI.add_argument(
    ...
    CLI.add_argument(
        ...
        type=float,
        default=0.01,
        help="each batch has fraction_new_experiences% of new experiences and "
             "fraction_new_experiences% of old experiences")
    CLI.add_argument(
        "--HER_decay_mode",
        nargs="?",
        type=str,
    ...
    CLI.add_argument('--num_hidden', type=int, default=16)
